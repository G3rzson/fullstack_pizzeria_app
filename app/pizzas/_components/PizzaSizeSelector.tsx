...
export default function PizzaSizeSelector({ pizza }: { pizza: any }) {
      ...
      <div className="flex flex-row items-center justify-between w-full">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <Label
              htmlFor={size32Id}
              className={`cursor-pointer ${selectedPizzaSize === "size32" ? "text-green-500" : ""}`}
            >
              32 cm
            </Label>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Label
              htmlFor={size45Id}
              className={`cursor-pointer ${selectedPizzaSize === "size45" ? "text-green-500" : ""}`}
            >
              45 cm
            </Label>
          </div>
