        ...
        <CardContent className="space-y-6">
          <section>
            ...
            <p className="text-muted-foreground">
              Ez egy demo/portfólió projekt, amely nem valós üzleti
              tevékenységet folytat. Az alkalmazás kizárólag bemutatási célokat
              szolgál.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              <li>
                <strong>Regisztráció:</strong> Email cím, név, jelszó
                (titkosítva)
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              azonban felhívjuk figyelmedet, hogy ez egy demo alkalmazás, ezért
              ne használj valós vagy érzékeny adatokat.
            </p>
          </section>
